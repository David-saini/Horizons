                    ...
                    <div className='max-w-[700px] w-full lg:max-w-[461px]' data-aos="fade-left" data-aos-duration="500" data-aos-delay="300" data-aos-easing="linear">
                        <form onSubmit={handleFormSubmission}>
                            <div className='flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-[21px]'>
                                <input className='bg-white input_card p-4 rounded-[16px] font-kanit w-full outline-none text-base leading-[150%] font-light' placeholder='First Name' type="text" value={Name} onChange={(e) => setName(e.target.value)} />
                                <input className='bg-white input_card p-4 rounded-[16px] font-kanit w-full outline-none text-base leading-[150%] font-light' placeholder='Last Name' type="text" value={Lastname} onChange={(e) => setLastname(e.target.value)} />
                            </div>
                            <div className='flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-[21px] mt-4'>
                                <input className='bg-white input_card p-4 rounded-[16px] font-kanit w-full outline-none text-base leading-[150%] font-light' placeholder='Email' type="Email" value={Email} onChange={(e) => setEmail(e.target.value)} />
                                <input className='bg-white input_card p-4 rounded-[16px] font-kanit w-full outline-none text-base leading-[150%] font-light' placeholder='Mobile no.' type="phone" value={Mobile} onChange={(e) => setMobile(e.target.value)} />
                            </div>
                            <div className='flex items-center justify-center gap-[21px] mt-4'>
                                <textarea placeholder='Write your message...' className='font-light text-base font-kanit w-full min-h-[140px] leading-[150%] rounded-[16px] p-4 input_card resize-none outline-none' type='text' value={Msg} onChange={(e) => setMsg(e.target.value)}></textarea>
                            </div>
