        ...
        <div className='header_bg min_h_screen !bg-center !bg-cover !bg-no-repeat relative'>
            ...
            <div className='max-w-[1440px] mx-auto'>
                <div className='max-w-[1164px] px-5 md:px-3 mx-auto'>
                    ...
                    <div className='bg-white border-white border-solid rounded-[32px] p-6 xl:p-8 input_card mt-[-80px] sm:mt-0 translate-y-[20%] sm:translate-y-[40%] lg:translate-y-[50%] xl:translate-y-[70%]'>
